"""autogenerated by genpy from util_msgs/SO3Command.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','geometry_msgs/Quaternion','float64[3]','float64[3]','util_msgs/AuxCommand']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.kOm is None:
        self.kOm = [0.,0.,0.]
      if self.aux is None:
        self.aux = util_msgs.msg.AuxCommand()
    else:
      self.header = std_msgs.msg.Header()
      self.force = geometry_msgs.msg.Vector3()
      self.orientation = geometry_msgs.msg.Quaternion()
