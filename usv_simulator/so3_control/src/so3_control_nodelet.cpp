...
#include <util_msgs/Corrections.h>
#include <util_msgs/PositionCommand.h>
...
private:
  ...
  void position_cmd_callback(
    const util_msgs::PositionCommand::ConstPtr& cmd);
  void odom_callback(const nav_msgs::Odometry::ConstPtr& odom);
  void enable_motors_callback(const std_msgs::Bool::ConstPtr& msg);
  void corrections_callback(const util_msgs::Corrections::ConstPtr& msg);
...
SO3ControlNodelet::publishSO3Command(void)
{
  ...
  util_msgs::SO3Command::Ptr so3_command(
    new util_msgs::SO3Command); //! @note memory leak?
...
SO3ControlNodelet::corrections_callback(
  const util_msgs::Corrections::ConstPtr& msg)
{
...
SO3ControlNodelet::onInit(void)
{
  ...
  so3_command_pub_ = n.advertise<util_msgs::SO3Command>("so3_cmd", 10);
